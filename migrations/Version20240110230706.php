 ...
 */
final class Version20240110230706 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mail_edu_educateurs (id INT AUTO_INCREMENT NOT NULL, mail_edu_id INT NOT NULL, educateur_id INT NOT NULL, INDEX id (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = MyISAM COMMENT = \'\' ');
    }
}
